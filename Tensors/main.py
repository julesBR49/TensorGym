...
Config.set('kivy', 'window_icon', '/Users/reaghbruce-robertson/PycharmProjects/Tensors/TensorGym1024-1x.png')
    ...
    def compute(self):
        try:
            ...
            if base_equation.getCov():
                self.open_pop("/Users/reaghbruce-robertson/PycharmProjects/Tensors/cov_warning.png")
            ...
            self.open_except_pop("error_popup.png")
...
class TensorGymApp(App):
    ...
    def build(self):
        ...
        self.icon = "/Users/reaghbruce-robertson/PycharmProjects/Tensors/TensorGym1024-1x.png"
